...
func ConfigKeyChecker(key string, instanceType api.InstanceType) (func(value string) error, error) {
	...
	// Systemd credential key/value pair passed as a read-only bind mount in containers and as SMBIOS 11 data in virtual machines.
	// ---
	//  type: string
	//  liveupdate: yes
	...
	// Systemd credential key/value pair passed as a read-only bind mount in containers and as SMBIOS 11 data in virtual machines. The value is Base64 encoded.
	// ---
	//  type: string
	//  liveupdate: yes
